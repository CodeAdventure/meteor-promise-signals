# Promise Signals [![Build Status](https://travis-ci.org/CodeAdventure/meteor-promise-signals.svg?branch=master)](https://travis-ci.org/CodeAdventure/meteor-promise-signals)
